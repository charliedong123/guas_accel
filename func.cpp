...
//
////calculate the gaus
//				gusRowLoop_2:for(Rsj=0;Rsj<Resize_factor;Rsj++)
//				{
//					gusColoumLoop_2:for(Rsi=0;Rsi<Resize_factor;Rsi++)
//					{
//
//						gusZLoop_2:for(int z=0;z<16;z++)
//						{
...
//
//
////write the calculate 5*5 matrix value to  the result picture image
//				gusRowLoop_3:for(Rsj=0;Rsj<Resize_factor;Rsj++)
//				{
//					gusColoumLoop_3:for(Rsi=0;Rsi<Resize_factor;Rsi++)
//					{
//
//						gusZLoop_3:for(int z=0;z<16;z++)
//						{
